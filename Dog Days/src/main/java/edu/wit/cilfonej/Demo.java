...
import edu.wit.cilfonej.database.model.Contact;
import edu.wit.cilfonej.database.model.Contact.EmailContact;
import edu.wit.cilfonej.database.model.Contact.PhoneContact;
...
import edu.wit.cilfonej.database.repository.DistributorRepository;
import edu.wit.cilfonej.database.repository.DogRepository;
import edu.wit.cilfonej.database.repository.DrugRepository;
import edu.wit.cilfonej.database.repository.FosterRepository;
